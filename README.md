...
A Plataforma de e-commerce fullstack para produtos digitais e serviços freelance, desenvolvida como projeto académico na ESTG (Instituto Politécnico Jean Piaget do Sul).
...
3. Cria a base de dados
   ...
   - Importa os ficheiro  sql da pasta sql/
...
5. Inicia o Apache e o MySQL no painel do XAMPP
